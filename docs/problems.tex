...
\vspace*{50mm}
\begin{center}
    \huge \texttt{manim} 常见问题 \textit{v2.4} \\
    \hspace*{\fill} \\
    \LARGE 鹤翔万里\& catfish \\
    \today
\end{center}
...
\subsubsection*{Q2: 缺少模块\texttt{pygments}}
...
再进行尝试。如果仍然出错，尝试将\texttt{ctex\_template.tex}中的\texttt{\textbackslash usepackage\{ctex\}}提到该文件的第二行再进行尝试。
还出错误的话，向下继续按步骤进行：
