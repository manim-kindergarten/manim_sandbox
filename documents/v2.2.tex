...
\fancyhf{}
\fancyfoot[L]{
    \includegraphics[height=2\baselineskip]{Logo(1).png}
    \begin{tabular}[b]{l}
...
\begin{figure}[htbp]
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{linear.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{lingering.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{result.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{running_start.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{rush_from.png}}    
    \end{minipage}
\end{figure}

\begin{figure}[htbp]
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{rush_into.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{slow_into.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{smooth.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{wiggle.png}}    
    \end{minipage}
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{there_and_back.png}}    
    \end{minipage}
\end{figure}

\begin{figure}[htbp]
    \begin{minipage}{0.18\linewidth}
        \centerline{\includegraphics[width=1in]{double_smooth.png}}    
    \end{minipage}
    \begin{minipage}{0.2\linewidth}
        \centerline{\includegraphics[width=1.2in]{exponential_decay.png}}    
    \end{minipage}
    \begin{minipage}{0.3\linewidth}
        \centerline{\includegraphics[width=1.8in]{there_and_back_with_pause.png}}    
    \end{minipage}
\end{figure}
